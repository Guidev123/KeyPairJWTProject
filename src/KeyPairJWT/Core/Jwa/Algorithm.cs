...
public class Algorithm
{
    ...
    public Algorithm WithContentEncryption(EncryptionAlgorithmContent enc)
    {
        ...
        switch (enc)
        {
            case EncryptionAlgorithmContent.Aes128CbcHmacSha256:
            case EncryptionAlgorithmContent.Aes128Gcm:
            case EncryptionAlgorithmContent.Aes192CbcHmacSha384:
            case EncryptionAlgorithmContent.Aes192Gcm:
            case EncryptionAlgorithmContent.Aes256CbcHmacSha512:
